...
SELECT COUNT(DISTINCT MASP)  AS SANPHAM
...
SELECT MIN(TRIGIA) GIATHAPNHAT, 
MAX(TRIGIA) GIACAONHAT 
FROM HOADON
GO
...
RANK() OVER (ORDER BY DOANHSO DESC) RANK_KH 
FROM KHACHHANG
GO
